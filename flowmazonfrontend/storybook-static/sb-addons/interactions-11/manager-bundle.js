try {
  (() => {
    ...
    var Pa = O((Ra, vn) => {
      ...
      l();
      (function (e) {
        if (typeof Ra == 'object' && typeof vn < 'u') vn.exports = e();
    ...
    var Ar = O((_D, bi) => {
      ...
      var yi = mi(),
        Dm = ct(),
        gi = Object.prototype,
        Rm = gi.hasOwnProperty,
        Pm = gi.propertyIsEnumerable,
        Fm = yi(
          (function () {
            return arguments;
          })(),
    ...
    var xn = O((Gt, wt) => {
      ...
      var qm = ze(),
        Mm = Si(),
        Ci = typeof Gt == 'object' && Gt && !Gt.nodeType && Gt,
        Ai = Ci && typeof wt == 'object' && wt && !wt.nodeType && wt,
        jm = Ai && Ai.exports === Ci,
        wi = jm ? qm.Buffer : void 0,
        Lm = wi ? wi.isBuffer : void 0,
        km = Lm || Mm;
      wt.exports = km;
    });
    var wr = O((kD, _i) => {
    ...
    var Qu = O((u3, Ju) => {
      ...
      Ir.prototype.add = Ir.prototype.push = D2;
      Ir.prototype.has = R2;
      Ju.exports = Ir;
    });
    var es = O((p3, Zu) => {
    ...
    var zs = O((I5, $s) => {
      ...
      var kn = Ts(),
        ...
        H0 = It(Hn),
        pt = ks;
      ((kn && pt(new kn(new ArrayBuffer(1))) != Ls) ||
        ($n && pt(new $n()) != Ns) ||
        (zn && pt(zn.resolve()) != qs) ||
        (Un && pt(new Un()) != Ms) ||
        (Hn && pt(new Hn()) != js)) &&
    ...
    var Xs = O((F5, Ks) => {
      ...
      function J0(e, t, r, n, o, a) {
        ...
        return f ? (a || (a = new Wn()), V0(e, t, r, n, o, a)) : !1;
      }
      Ks.exports = J0;
    });
    var Gn = O((M5, Zs) => {
    ...
    var fl = O((mB, pl) => {
      ...
      function Kn(e, t) {
        ...
        return (r.cache = new (Kn.Cache || cl)()), r;
      }
      Kn.Cache = cl;
      pl.exports = Kn;
    });
    ...
    var wl = O((RB, Al) => {
      ...
      function Sl(e) {
        ...
        if (Fb(e)) return Pb(e, Sl) + '';
        if (Bb(e)) return vl ? vl.call(e) : '';
        var t = e + '';
    ...
    var Pc = O((S9, Rc) => {
      ...
      function kE(e) {
        ...
        return typeof r == 'function' && r instanceof r && Dc.call(r) == LE;
      }
      Rc.exports = kE;
    });
    var Nc = O((D9, Bc) => {
    ...
    var fp = O((Hq, pp) => {
      ...
      var ao = { __proto__: null, foo: {} },
        Cv = Object;
      pp.exports = function () {
        return { __proto__: ao }.foo === ao.foo && !(ao instanceof Cv);
      };
    });
    var mp = O((Yq, hp) => {
      'use strict';
    ...
    var Nr = O((Qq, yp) => {
      ...
      l();
      var Rv = mp();
      yp.exports = Function.prototype.bind || Rv;
    });
    var bp = O((rM, gp) => {
      'use strict';
      u();
    ...
    var ht = O((iM, wp) => {
      ...
      if (we)
        try {
          ...
          (Ep = we(we(e))), (dt['%Error.prototype%'] = Ep);
        }
      var Ep,
        Uv = function e(t) {
          var r;
        ...
        Sp = er.call(Function.call, String.prototype.replace),
        ...
        Kv = function (t) {
          ...
          var o = [];
          return (
            Sp(t, Vv, function (a, i, c, p) {
              o[o.length] = c ? Sp(p, Yv, '$1') : i || a;
            }),
            o
          );
        },
        Xv = function (t, r) {
          var n = t,
            o;
          if ((qr(vp, n) && ((o = vp[n]), (n = '%' + o[0] + '%')), qr(dt, n))) {
            var a = dt[n];
    ...
    var Lr = O((cM, Cp) => {
      ...
      l();
      var Jv = ht(),
        jr = Jv('%Object.defineProperty%', !0) || !1;
      if (jr)
        try {
          jr({}, 'a', { value: 1 });
        } catch {
    ...
    var so = O((hM, _p) => {
      ...
      l();
      var Qv = ht(),
        kr = Qv('%Object.getOwnPropertyDescriptor%', !0);
      if (kr)
        try {
          kr([], 'length');
        } catch {
    ...
    var Mp = O((OM, qp) => {
      ...
      qp.exports = function (t, r) {
        ...
        return (
          (o || a || !n) &&
            (tS ? Fp(t, 'length', r, !0, !0) : Fp(t, 'length', r)),
          t
        );
      };
    });
    ...
    var Vp = O((BM, Gp) => {
      ...
      var Hp = ht(),
        Wp = Up(),
        iS = Wp(Hp('String.prototype.indexOf'));
      Gp.exports = function (t, r) {
        var n = Hp(t, !!r);
        return typeof n == 'function' && iS(t, '.prototype.') > -1 ? Wp(n) : n;
      };
    });
    var Yp = O(() => {
      u();
    ...
    var mf = O((UM, hf) => {
      ...
      var So = typeof Map == 'function' && Map.prototype,
        ...
        Jp = lS ? WeakRef.prototype.deref : null,
      ...
      hf.exports = function e(t, r, n, o) {
        ...
        if (DS(t)) {
          for (
            ...
            x += ' ' + P[D].name + '=' + cf(yS(P[D].value), 'double', a);
          return (
            (x += '>'),
        ...
        if (OS(t)) return mo('WeakMap');
        if (IS(t)) return mo('WeakSet');
        if (xS(t)) return mo('WeakRef');
        if (vS(t)) return tr(f(Number(t)));
        if (AS(t)) return tr(f(yo.call(t)));
      ...
      function df(e, t) {
        if (e.length > t.maxStringLength) {
          ...
          return df(wo.call(e, 0, t.maxStringLength), t) + n;
        }
    ...
    var To = O((tj, Sf) => {
      ...
      var VS = Yr(),
          ...
          return (
            ...
            mt(t) && mt(r)
              ...
              : Object.keys(r).reduce(function (a, i) {
                  var c = r[i];
                  return Oo.call(a, i) ? (a[i] = e(a[i], c, n)) : (a[i] = c), a;
                }, o)
          );
        },
        XS = function (t, r) {
        ...
        QS = function (t, r, n, o, a) {
          ...
          for (var c = '', p = 0; p < i.length; p += xo) {
            for (
              var d = i.length >= xo ? i.slice(p, p + xo) : i, h = [], m = 0;
              m < d.length;
              ++m
            ) {
            ...
            if (p !== c) {
              ...
              f === -1
                ...
                : ((w = r.decoder(h.slice(0, f), be.decoder, d, 'key')),
                  (g = Lt.maybeMap(Tf(h.slice(f + 1), r), function (x) {
          ...
          if (t) {
            ...
            for (
              ...
              if (
                ((m += 1),
                !n.plainObjects &&
                  Do.call(Object.prototype, p[1].slice(1, -1)) &&
                  !n.allowPrototypes)
              )
                return;
              h.push(p[1]);
      ...
      `),
            ...
            : (r.add(e),
              Array.isArray(e)
                ...
                : {
                    name: 'object',
                    value: (0, ar.default)(e, (o) => Po(o, t, new Set(r))),
                  })
          : { name: 'object', value: {} };
      },
      LA = (e) => {
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
            ...
            function g() {
              ...
              return ln.colors && (ln.stylize = w), ln;
            }
            function A(b, C) {
              var q =
...
`,
            ...
            var jd =
              ...
              dr = jd ? Symbol.for('chai/inspect') : '@@chai/inspect',
              Et = !1;
            try {
              var ua = KA('util');
              Et = ua.inspect ? ua.inspect.custom : !1;
            } catch {
              Et = !1;
            }
            function sa() {
            ...
            var hr = new (typeof WeakMap == 'function' ? WeakMap : sa)(),
              mr = {},
              la = {
            ...
            function yr(b, C) {
              ...
              var q = C,
                G = q.customInspect,
                K = b === null ? 'null' : n(b);
              if ((K === 'object' && (K = kd.call(b).slice(8, -1)), la[K]))
                return la[K](b, C);
              if (G && b) {
                var re = Ld(b, C, K);
    ...
    qo.open = '';
    qo.close = '';
    var dL = lw.reduce((e, [t]) => ((e[t] = qo), e), { isColorSupported: !1 });
    var {
    ...
    function sr(e) {
      ...
      return (
        (sr = function (n) {
          ...
          function o() {
            return ko(n, arguments, ur(this).constructor);
          }
          return (
    ...
    function Wo(e, t, r) {
      if (typeof e == 'number' && typeof t == 'number' && typeof r == 'number')
        return Ho('#' + gt(e) + gt(t) + gt(r));
      if (typeof e == 'object' && t === void 0 && r === void 0)
        return Ho('#' + gt(e.red) + gt(e.green) + gt(e.blue));
      throw new Pe(6);
    }
    function en(e, t, r, n) {
              ...
              y.createElement(
                ...
                y.createElement(
                  st,
                  {
                    trigger: 'hover',
                    hasChrome: !1,
                    tooltip: y.createElement(cr, { note: 'Go to start' }),
                  },
                  y.createElement(
                    gC,
                    {
                ...
                y.createElement(
                  st,
                  {
                    trigger: 'hover',
                    hasChrome: !1,
                    tooltip: y.createElement(cr, { note: 'Go back' }),
                  },
                  y.createElement(
                    pr,
                    {
                ...
                y.createElement(
                  st,
                  {
                    trigger: 'hover',
                    hasChrome: !1,
                    tooltip: y.createElement(cr, { note: 'Go forward' }),
                  },
                  y.createElement(
                    pr,
                    {
                ...
                y.createElement(
                  st,
                  {
                    trigger: 'hover',
                    hasChrome: !1,
                    tooltip: y.createElement(cr, { note: 'Go to end' }),
                  },
                  y.createElement(
                    pr,
                    {
                ...
                y.createElement(
                  st,
                  {
                    trigger: 'hover',
                    hasChrome: !1,
                    tooltip: y.createElement(cr, { note: 'Rerun' }),
                  },
                  y.createElement(
                    EC,
    ...
    var na = (e) =>
      ...
      wC = (e) =>
        _d(e) || na(e) || typeof e == 'function' || e instanceof Promise,
      Od = (e) => {
        let t = /unique/;
      ...
      rn = (e) => {
        let {
          ...
          h = (0, TC.default)(e, DC),
          { themeClass: m, currentTheme: f } = on(
        ...
        let A = (N) => {
          ...
          { isChild: X, depth: _, hasHover: R } = y.useContext(Vo),
          B = R ? r : !1;
        if (!X)
          return y.createElement(
            'ul',
            ...
            y.createElement(
              ...
              y.createElement(rn, e),
            ),
          );
        if (!x)
          return y.createElement(
            'li',
            (0, Go.default)({ role: 'treeitem', className: Fe.item }, h),
            y.createElement(
              'div',
              {
                role: 'button',
        ...
        return y.createElement(
          ...
          y.createElement(
            'ul',
            (0, Go.default)({ role: 'group', className: Ye(i, Fe.group) }, h),
            w &&
              y.Children.map(o, (N) =>
                y.createElement(
                  Vo.Provider,
    ...
    var RC = $e(ta()),
      ...
      xd = (e) => {
        let { ast: t, theme: r, showKey: n, colorScheme: o, className: a } = e,
          i = (0, PC.default)(e, FC),
          { themeClass: c } = on({ theme: r, colorScheme: o }, pe),
    ...
    var Td = xd,
      ...
      Id = (e) => {
        let {
          ...
          c = (0, BC.default)(e, NC),
          { themeClass: p, currentTheme: d } = on(
...
`);
        return y.createElement(
          ...
          r.flatMap((n, o) => {
            if (n.startsWith('expect(')) {
              ...
              if (f) {
                ...
                if (g)
                  return [
                    'expect(',
                    y.createElement(Ko, { key: `received_${h}`, value: h }),
                    n.slice(m, w),
                    y.createElement(Xo, { key: `expected_${g}`, value: g }),
                    n.slice(w + g.length),
            ...
            if (n.match(/^\s*- /))
              return [
                y.createElement(Xo, { key: n + o, value: n }),
                y.createElement('br', { key: `br${o}` }),
              ];
            if (n.match(/^\s*\+ /) || n.match(/^Received: $/))
              return [
                y.createElement(Ko, { key: n + o, value: n }),
                y.createElement('br', { key: `br${o}` }),
              ];
            ...
            return d
              ? [
                  'Received has value: ',
                  y.createElement(bt, { key: n + o, value: Yo(d) }),
                  y.createElement('br', { key: `br${o}` }),
                ]
              : [
    ...
    var h_ = ie.div(() => ({
      ...
      v_ = ie(mn)(({ theme: e }) => ({ fontFamily: e.typography.fonts.base })),
      gd = ie('div')(({ theme: e }) => ({
        padding: '8px 10px 8px 36px',
        fontSize: Xe.size.s1,
...
`),
      ...
      __ = () => {
        let [e, t] = ke(!0),
          r = Ea().getDocsUrl({ subpath: lC, versioned: !0, renderer: !0 });
        return (
          Qe(() => {
            let n = setTimeout(() => {
              t(!1);
          ...
          c &&
            ne(
              ...
              ne(
                ...
                ne(Jo, null, 'test.dangerouslyIgnoreUnhandledErrors'),
                ' ',
                'parameter to ',
                ne(Jo, null, 'true'),
                '.',
    ...
    var Qo = { start: !1, back: !1, goto: !1, next: !1, end: !1 },
      ...
      I_ = br(function ({ storyId: e }) {
        ...
        return p
          ? y.createElement(gr, { key: 'interactions' })
          : y.createElement(
              gr,
              { key: 'interactions' },
              y.createElement(T_, {
