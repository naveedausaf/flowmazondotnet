module "flowmazonfrontend" {
  source = "github.com/EnableHub/flowmazondotnet.git//.iac/modules/flowmazonfrontend?ref=main"
...
module "db_branch" {
  source = "github.com/EnableHub/flowmazondotnet.git//.iac/modules/db_branch?ref=main"
