locals {
  full_image_name = "${var.image_login_server}/${var.image_repository}:${var.image_tag}"
}
...
resource "azurerm_container_app" "app" {
  ...
  secret {
    ...
    identity            = var.managed_identity_id
    key_vault_secret_id = var.vault_secretid_for_connectionstring
  }
  ...
  template {
    ...
    container {
      ...
      env {
        ...
        secret_name = var.vault_secretname_for_connectionstring
      }
